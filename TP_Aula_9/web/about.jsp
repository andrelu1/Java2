...
<html>
  ...
  height: 100vh;
  min-height:100vh;
  font-family: 'Noto Sans', sans-serif -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Droid Sans, Helvetica Neue, sans-serif;
}
body:active div,
...
<div class="box">
 <form>
        ...
        <h2 class="gradient-multiline"><span>André Luis Rosa Mastrocola</span></h2>
        <h2 class="gradient-multiline"><span>R.A. 1290482012004</span></h2>  
        <h2 class="gradient-multiline"><span><a href="https://github.com/andrelu1/Java">Meu Github</a></span></h2>    
        </span>
     </form>	
   </div>
  </body>
